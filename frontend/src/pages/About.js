  ...
  return (
    <>
      <div className="flex flex-col h-full">
        <div className="flex flex-col h-full">
          <h1 className="pt-10 text-center text-5xl font-bold">About Us</h1>
          <div className="flex w-full mt-10 px-20">
            <div className="flex-1 p-10 text-center text-xl bg-gray-400 text-primaryText rounded-xl mx-5">
              <h1 className="text-2xl underline pb-5">ድርጅቱ የተቋቋመበት ዓላማ</h1>
              <p>
            ...
            <div className="flex-1 p-10 text-center text-xl bg-gray-400 text-primaryText rounded-xl mx-5">
              <h1 className="text-2xl underline pb-5">Aim of the company</h1>
              <p>
          ...
          <div className="flex bg-gray-400 text-primaryText rounded-xl mx-10 mt-20">
            <div className="flex-1 p-5 text-center text-3xl  mx-5 w-1/3">
              <h1 className="text-2xl underline pb-5">የድርጅቱ ራዕይ </h1>
              <p className="text-xl">
                በሃገሪቱ በተፈጥሮ ፍልውሃ መታጠቢያ በስፓ በሆቴል አገልግሎት ግንባር ቀደምና ተመራጭ ሆኖ ማየት፡፡
              </p>

              <h1 className="text-2xl underline pb-5 mt-5">Vision</h1>
              <p className="text-xl">
            ...
            <div className="flex-1 p-5 text-center text-3xl  mx-5 w-1/3">
              <h1 className="text-2xl underline pb-5">የድርጅቱ ተልዕኮ</h1>
              <p className="text-xl">
              ...
              <h1 className="text-2xl underline pb-5 mt-5">Mission</h1>
              <p className="text-xl">
            ...
            <div className="flex-1 p-5 text-center text-3xl  mx-5 w-1/3">
              <h1 className="text-2xl underline pb-5">የድርጅቱ እሴት</h1>
              <p className="text-xl">
              ...
              <h1 className="text-2xl underline pb-5 mt-5">Purpose</h1>
              <p className="text-xl">
