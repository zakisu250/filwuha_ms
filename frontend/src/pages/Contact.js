    ...
    <>
      <div className="flex justify-center items-center h-full">
        <div className="flex w-full h-full">
          <div className="flex justify-center items-center text-center p-5 w-full mx-10 mt-5">
            ...
            <div className="flex flex-col flex-1 w-full">
              ...
              ></iframe>
              <div className="flex flex-col border mt-5 py-5 shadow-lg">
              ...
              <div className="items-center p-5 w-full transition-all">
